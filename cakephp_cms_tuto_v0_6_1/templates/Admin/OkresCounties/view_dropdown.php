...
<?= $this->Html->link(__('Edit Okres County'), ['action' => 'edit', $okresCounty->id], ['class' => 'nav-link']) ?>
<?= $this->Form->postLink(__('Delete Okres County'), ['action' => 'delete', $okresCounty->id], ['confirm' => __('Are you sure you want to delete # {0}?', $okresCounty->id), 'class' => 'nav-link']) ?>
<?= $this->Html->link(__('List Okres Counties'), ['action' => 'index'], ['class' => 'nav-link']) ?>
<?= $this->Html->link(__('New Okres County'), ['action' => 'add'], ['class' => 'nav-link']) ?>
<?= $this->Html->link(__('List Kraj Regions'), ['controller' => 'KrajRegions', 'action' => 'index'], ['class' => 'nav-link']) ?>
<?= $this->Html->link(__('New Kraj Region'), ['controller' => 'KrajRegions', 'action' => 'add'], ['class' => 'nav-link']) ?>
<?= $this->Html->link(__('List Obec Cities'), ['controller' => 'ObecCities', 'action' => 'index'], ['class' => 'nav-link']) ?>
<?= $this->Html->link(__('New Obec City'), ['controller' => 'ObecCities', 'action' => 'add'], ['class' => 'nav-link']) ?>
<?php $this->end(); ?>
