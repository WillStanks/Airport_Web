...
<li><?= $this->Html->link(__('Edit Okres County'), ['action' => 'edit', $okresCounty->id], ['class' => 'nav-link']) ?></li>
<li><?= $this->Form->postLink(__('Delete Okres County'), ['action' => 'delete', $okresCounty->id], ['confirm' => __('Are you sure you want to delete # {0}?', $okresCounty->id), 'class' => 'nav-link']) ?></li>
